...
export const getAllCategories = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const categories = await CategorySubToolModel.findAll();
...
export const getCategoryById = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const category = await CategorySubToolModel.findById(req.params.id);
...
export const createCategory = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const category = await CategorySubToolModel.create(req.body);
...
export const updateCategory = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const updated = await CategorySubToolModel.update(req.params.id, req.body);
...
export const deleteCategory = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    await CategorySubToolModel.delete(req.params.id);
